...
MusicoRefuerzo msr1 = new MusicoRefuerzo("Juan", "Jaén Bernal", "tuba", new BigDecimal(1545.99));
act1.annadirParticipante(msr1);
Actuacion act2 = new Actuacion(LocalDate.of(2019, 12, 16));
bd.annadirActuacion(act2);
MusicoRefuerzo msr2 = new MusicoRefuerzo("María", "López Gil", "oboe", new BigDecimal(1689.30));
